...
class MainFrame extends JFrame {
    ...
    public JPanel createLoginPanel() {
        ...
        field(emailLabel, panel, emailText, 50, 90, 150, 25, 200, 90, 200, 25);

        // Add a password label
        JLabel passwordLabel = new JLabel("Password:");
        JPasswordField passwordText = new JPasswordField(20);

        field(passwordLabel, panel, passwordText, 50, 120, 190, 25, 200, 120, 200, 25);
        ...
        JLabel registerLabel = new JLabel("<html><u>Not registered? Register</u></html>");
        registerLabel.setForeground(Color.RED);
        registerLabel.setBounds(150, 200, 200, 25);
    ...
    public JPanel createRegisterPanel() {
        ...
        radioButtonTemplate(femaleButton, panel, 270, 180, 100, 25);

        JRadioButton otherButton = new JRadioButton("Other");
        radioButtonTemplate(otherButton, panel, 340, 180, 130, 25);
        ...
        registerButton.setBounds(200, 280, 100, 25);
        ...
        JLabel loginLabel = new JLabel("<html><u>Already registered? Login</u></html>");
        loginLabel.setForeground(Color.RED);
        loginLabel.setBounds(150, 320, 200, 25);
    ...
    public JPanel createProductPanel(String name, String description, String price) {
        ...
        panel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.RED, 2), // Red border for highlight
    ...
    private void showCartPage() {
        ...
        for (int i = 0; i < 20; i++) {
            JPanel cartProductPanel = createProductPanel("Cart Product " + (i + 1), "Description of cart product " + (i + 1), "$" + (i + 20));
    ...
    public void field(JLabel jLabel, JPanel panel, JTextField textField, int x, int y, int width1, int height1, int x1, int y1, int width2, int height2) {
